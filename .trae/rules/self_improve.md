...
When creating or updating rules, **ensure alignment with enterprise standards**:

- Reference [enterprise_methodology.md](.trae/rules/enterprise_methodology.md) for language-specific patterns
- Document SRP compliance patterns in new rules
- Include performance monitoring examples
- Specify circuit breaker requirements where applicable
...
4. Links to enterprise_methodology.md for context

This ensures all rules evolve within enterprise standards context.
